...
def run_audit():
    ...
    challenges = {
        "HN001": (
            PurchaseRecord(record_id="dummy_p", vendor_name="ABC", reference="INV-1042", amount=1000.0, record_date=date(2023,1,1), tax_identity="TAX1"),
            GSTRecord(record_id="dummy_g", vendor_name="ABC", reference="AB/1042", amount=2000.0, record_date=date(2023,1,1), tax_identity="TAX1"),
        ),
        "HN002": (
            PurchaseRecord(record_id="dummy_p", vendor_name="XYZ", reference="INV-1042", amount=1000.0, record_date=date(2023,1,1), tax_identity="TAX1"),
            GSTRecord(record_id="dummy_g", vendor_name="XYZ", reference="AB/1042", amount=1000.0, record_date=date(2023,1,1), tax_identity="TAX2"),
        ),
        "HN003": (
            PurchaseRecord(record_id="dummy_p", vendor_name="DEF", reference="INV-MAY", amount=1000.0, record_date=date(2023,5,1), tax_identity="TAX1"),
            GSTRecord(record_id="dummy_g", vendor_name="DEF", reference="INV-JUN", amount=1000.0, record_date=date(2023,6,1), tax_identity="TAX1"),
        ),
        "HN004": (
            PurchaseRecord(record_id="dummy_p", vendor_name="GHI", reference="OMD-001", amount=1000.0, record_date=date(2023,1,1), tax_identity="TAX1"),
            GSTRecord(record_id="dummy_g", vendor_name="GHI", reference="NSS-001", amount=1000.0, record_date=date(2023,1,1), tax_identity="TAX1"),
        ),
        "HN005": (
            PurchaseRecord(record_id="dummy_p", vendor_name="JKL", reference="INV-1042", amount=2000.0, record_date=date(2023,1,1), tax_identity="TAX1"),
            GSTRecord(record_id="dummy_g", vendor_name="JKL", reference="AB/1042", amount=1000.0, record_date=date(2023,1,1), tax_identity="TAX1"),
        )
    }
    ...
    for name, (ref_a, ref_b) in empty_pathologicals.items():
        p = PurchaseRecord(record_id="dummy_p", vendor_name="A", reference=ref_a, amount=100.0, record_date=date(2023,1,1), tax_identity="TAX")
        g = GSTRecord(record_id="dummy_g", vendor_name="A", reference=ref_b, amount=100.0, record_date=date(2023,1,1), tax_identity="TAX")
        try:
            res = score_purchase_to_gst(p, g, context)
